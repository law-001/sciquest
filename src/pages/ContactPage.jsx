...
export function ContactPage() {
  ...
  return (
    <div
      className="min-h-[calc(100vh-4rem)] py-12 md:py-20 px-4 sm:px-6 lg:px-8"
      style={{
      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <div className="hidden md:block bg-white p-6 rounded-3xl border border-orange-100 shadow-card relative overflow-hidden">
              ...
              <p className="font-bold text-stone-800 relative z-10">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="w-full">
                    ...
                    <textarea
                      className="w-full rounded-xl border-2 border-orange-200 bg-white px-4 py-3 text-stone-900 placeholder:text-stone-400 focus:border-primary-500 focus:outline-none focus:ring-4 focus:ring-primary-500/10 transition-all min-h-150px resize-y"
