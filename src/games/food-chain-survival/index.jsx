...
const GAME_ID = 'food-chain-survival';
const GAME_URL = `${import.meta.env.BASE_URL}games/food-chain-survival/index.html`;

// The game ships as a self-contained HTML/canvas prototype served from /public.
// It runs inside an iframe so its global CSS and React/Babel runtime stay fully
// isolated from the SciQuest app. The two sides talk only via postMessage.
export default function FoodChainSurvival({ user, profile, onExit, onProgressUpdate }) {
