  ...
  lessons: [
    ...
    // ═══════════════════════════════════════════════════
    {
      ...
      signature: {
        ...
        xp: 25,
        explainer: {
          title: "Energy alone changed the phase",
          points: [
            "The same particles gave you all five phases. Only their energy changed.",
            "Cold locked them into a lattice. Warmth broke them loose. Heat sent them flying free.",
            "When you pushed the heat far enough, they tore apart into charged bits: plasma.",
            "Near absolute zero they merged into one blur, the coldest phase of all.",
          ],
        },
      },
...

        {
          ...
          data: {
            concepts: [
              ...
              "When motion and attraction are roughly balanced, particles stay close but slide, so the substance is a liquid.",
          ...
          data: {
            ...
            steps: [
              ...
              },
              {
                ...
                tip: "Draw the other particles around your main character too, because one lonely particle cannot show arrangement.",
              },
              {
                num: 4,
...

        {
          ...
          data: {
            concepts: [
              ...
              "If you choose sublimation (dry ice) or deposition (frost), say so clearly, because skipping the liquid stage must be obvious in the drawing.",
